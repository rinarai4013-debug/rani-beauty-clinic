...
export const Default: Story = {
  args: {
    shareContent: {
      ...
      shareUrl: 'https://www.ranibeautyclinic.com/refer/SARAH50',
      smsText: 'Get $25 off your first treatment at Rani Beauty Clinic! Use code SARAH50. Book here: https://www.ranibeautyclinic.com/refer/SARAH50',
...
export const NewReferrer: Story = {
  args: {
    shareContent: {
      ...
      shareUrl: 'https://www.ranibeautyclinic.com/refer/EMILY25',
...
export const TopReferrer: Story = {
  args: {
    shareContent: {
      ...
      shareUrl: 'https://www.ranibeautyclinic.com/refer/MARIA100',
