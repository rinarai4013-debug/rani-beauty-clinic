...
import { INJECTION_LOG_TEMPLATE } from '@/lib/charting/templates';
...
export default function InjectionLogForm({ data, errors, onChange, readOnly }: InjectionLogFormProps) {
  const template = INJECTION_LOG_TEMPLATE;
