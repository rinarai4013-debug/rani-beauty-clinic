...
export default function ExitIntentPopup() {
  ...
  return (
    ...
    >
      ...
      {/* Modal Card */}
      <div
        className={`relative w-full max-w-lg rounded-2xl border-t-4 border-rani-gold bg-white p-8 shadow-2xl sm:p-10 transition-all duration-350 ease-out ${
          isVisible
            ? "opacity-100 scale-100 translate-y-0"
            : "opacity-0 scale-[0.9] translate-y-5"
        }`}
      >
        {/* Close Button */}
        <button
