        ...
        <div className="mx-auto max-w-7xl px-6 py-8">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-x-3 gap-y-1">
                {[
                  { name: "Botox vs Dysport", href: "/vs/botox-vs-dysport" },
                  { name: "Semaglutide vs Tirzepatide", href: "/vs/semaglutide-vs-tirzepatide" },
                  { name: "HydraFacial vs Chemical Peel", href: "/vs/hydrafacial-vs-chemical-peel" },
                  { name: "RF vs Sofwave", href: "/vs/rf-microneedling-vs-sofwave" },
                  { name: "Laser vs Electrolysis", href: "/vs/laser-hair-removal-vs-electrolysis" },
                  { name: "BioRePeel vs VI Peel", href: "/vs/biorepeel-vs-vi-peel" },
                  { name: "Laser vs Waxing", href: "/vs/laser-hair-removal-vs-waxing" },
                  { name: "Botox vs Fillers", href: "/vs/botox-vs-dermal-fillers" },
                  { name: "NAD+ vs B12", href: "/vs/nad-vs-vitamin-b12" },
                  { name: "Semaglutide vs Liraglutide", href: "/vs/semaglutide-vs-liraglutide" },
                  { name: "RF vs Traditional", href: "/vs/rf-microneedling-vs-traditional-microneedling" },
                  { name: "BioRePeel vs PRX-T33", href: "/vs/biorepeel-vs-prx-t33" },
                  { name: "HydraFacial vs Facial", href: "/vs/hydrafacial-vs-regular-facial" },
                  { name: "Sofwave vs Ultherapy", href: "/vs/sofwave-vs-ultherapy" },
                  { name: "Peptides vs HGH", href: "/vs/peptide-therapy-vs-hgh" },
