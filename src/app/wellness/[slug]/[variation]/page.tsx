  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: "Wellness",
        item: `${clinicInfo.website}/wellness`,
      },
      {
        "@type": "ListItem",
        position: 3,
        name: variation.parentTitle,
        item: `${clinicInfo.website}/wellness/${variation.parentSlug}`,
      },
      {
        "@type": "ListItem",
        position: 4,
...
export default function WellnessVariationPage({
  params,
}: {
  params: { slug: string; variation: string };
}) {
      ...
      <section className="py-16 sm:py-20 bg-[#0F1D2C] text-white text-center">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-white/70 text-lg mb-8">
            ...
            {variation.title.toLowerCase()} can support your wellness journey.
          </p>
