...
export function generateStaticParams() {
  return demographicPages.map((page) => ({ slug: page.slug }));
}
...
export function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `${clinicInfo.website}/treatments-for/${page.slug}`,
    },
    openGraph: {
      title: page.metaTitle,
      description: page.metaDescription,
      url: `${clinicInfo.website}/treatments-for/${page.slug}`,
...
export default function DemographicPage({
  ...
  const pageUrl = `${clinicInfo.website}/treatments-for/${page.slug}`;
      ...
      <article className="mx-auto max-w-4xl px-6 py-16 md:py-24">
        ...
        <section className="mb-12 rounded-xl border border-rani-border bg-rani-cream/30 p-6">
          ...
          <ul className="space-y-3">
            {page.uniqueConsiderations.map((item, i) => (
        ...
        <section className="rounded-xl bg-rani-navy p-8 text-center text-white">
          ...
          <p className="mt-3 text-rani-cream/80">
            Book a consultation and our team will create a personalized treatment
            plan for your goals.
          </p>
