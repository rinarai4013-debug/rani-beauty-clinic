...
export const agePages: AgePage[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "How much should I budget for skincare in my 30s?", answer: "A comprehensive 30s program including monthly HydraFacials, quarterly Botox, an annual RF Microneedling series, and quarterly peels represents a meaningful investment. Membership pricing reduces costs by 20 to 30 percent, and Cherry financing is available for larger treatments. Most clients spend more on their skincare budget in their 30s than their 20s, reflecting the increased intervention needed." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "How much does a comprehensive 40s anti-aging plan cost?", answer: "A comprehensive program including annual Sofwave, quarterly Botox, annual RF Microneedling series, and monthly HydraFacials represents a significant annual investment. Membership pricing, Cherry financing, and treatment packages make this investment manageable. Your provider will create a personalized plan with clear cost projections." },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          "When you calculate the lifetime cost of a prevention-focused anti-aging strategy, it is substantially less expensive than reactive treatments later in life. Patients who maintain consistent preventative care from their 20s through their 60s spend less cumulatively than patients who seek aggressive correction in their 50s and 60s after decades of neglect. The earlier you start, the less you spend per decade and the better your results. Membership pricing, Cherry financing, and strategic treatment planning at Rani Beauty Clinic make a lifetime anti-aging strategy accessible and predictable.",
      },
    ],
    faqs: [
