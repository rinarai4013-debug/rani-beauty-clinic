...
export const UNIFIED_CATALOG: UnifiedService[] = [
  ...
  { id: 'lhr-full-legs', name: 'Laser Hair Removal — Full Legs', category: 'laser-hair-removal', price: 375, duration: 43, sessions: 6, description: 'Complete leg hair reduction from hip to ankle', concerns: ['unwanted-hair'], bodyAreas: ['legs'], financingEligible: true, parentSlug: 'laser-hair-removal' },
