...
export const UNIFIED_CATALOG: UnifiedService[] = [
  ...
  { id: 'prx-t33', name: 'PRX-T33', category: 'chemical-peel', price: 495, duration: 60, sessions: 3, description: 'Non-peeling biorevitalization for deep hydration and collagen stimulation', concerns: ['aging-skin', 'dull-skin', 'hyperpigmentation', 'acne'], bodyAreas: ['face'], financingEligible: false, parentSlug: 'prx-t33' },
  { id: 'cosmelan-peel', name: 'Cosmelan Peel', category: 'chemical-peel', price: 1399, duration: 90, sessions: 2, description: 'Professional depigmentation treatment targeting melasma, hyperpigmentation, and uneven skin tone — the gold standard for pigment correction', concerns: ['hyperpigmentation', 'sun-damage', 'dull-skin'], bodyAreas: ['face'], financingEligible: true, parentSlug: 'cosmelan-peel' },
  { id: 'microneedling-arrissence-undereye', name: 'Microneedling with Arrissence — Dark Undereyes', category: 'rf-microneedling', price: 695, duration: 60, sessions: 3, description: 'Targeted undereye microneedling with Arrissence growth factor serum for dark circles, hollowness, and fine lines', concerns: ['undereye', 'aging-skin', 'dull-skin'], bodyAreas: ['face'], financingEligible: false, parentSlug: 'rf-microneedling', packageDiscounts: [{ qty: 3, discount: 10 }] },
  ...
  { id: 'red-light-therapy', name: 'Red Light Therapy', category: 'facial', price: 49, duration: 15, sessions: 8, description: 'Photobiomodulation session that supports recovery, inflammation control, and skin renewal', concerns: ['aging-skin', 'dull-skin', 'acne'], bodyAreas: ['body'], financingEligible: false, parentSlug: 'red-light-therapy' },
  { id: 'laser-acne-facial', name: 'Laser Acne Facial', category: 'laser', price: 475, duration: 90, sessions: 3, description: 'Laser and light-based acne treatment for active breakouts, inflammation, and post-acne discoloration', concerns: ['acne', 'hyperpigmentation'], bodyAreas: ['face'], financingEligible: true, parentSlug: 'laser-acne-facial' },
  { id: 'ai-skin-analysis', name: 'AI Skin Analysis', category: 'consultation', price: 0, duration: 30, sessions: 1, description: 'Advanced imaging-driven skin assessment used to personalize treatment planning', concerns: ['aging-skin', 'acne', 'hyperpigmentation', 'dull-skin'], bodyAreas: ['face'], financingEligible: false, parentSlug: 'ai-skin-analysis', note: 'Complimentary with consultation' },
  ...
  // ═══ HORMONE THERAPY ═══
  { id: 'hormone-female-hrt', name: 'Female HRT (Estradiol + Progesterone)', category: 'hormones', price: 199, duration: 30, sessions: 1, description: 'Bioidentical hormone replacement protocol for perimenopause and menopause symptom management', concerns: [], bodyAreas: [], financingEligible: true, parentSlug: 'hormone-therapy' },
  { id: 'hormone-male-trt', name: 'Male TRT (Testosterone Cypionate)', category: 'hormones', price: 199, duration: 30, sessions: 1, description: 'Physician-supervised testosterone replacement protocol for low testosterone symptoms', concerns: [], bodyAreas: [], financingEligible: true, parentSlug: 'hormone-therapy' },
  { id: 'hormone-thyroid-optimization', name: 'Thyroid Optimization', category: 'hormones', price: 149, duration: 30, sessions: 1, description: 'Targeted thyroid support protocol for metabolic and endocrine optimization', concerns: [], bodyAreas: [], financingEligible: true, parentSlug: 'hormone-therapy' },

  // ═══ LABS ═══
  { id: 'blood-work-wellness-panel', name: 'Wellness Screening Panel', category: 'labs', price: 149, duration: 15, sessions: 1, description: 'Comprehensive in-house wellness blood panel used for baseline and ongoing monitoring', concerns: [], bodyAreas: [], financingEligible: false, parentSlug: 'blood-work' },
