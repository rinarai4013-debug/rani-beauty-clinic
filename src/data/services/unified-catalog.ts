...
export const UNIFIED_CATALOG: UnifiedService[] = [
  ...
  { id: 'hrt-female-start', name: 'Female HRT - Start Protocol', category: 'hormones', price: 349, duration: 30, sessions: 1, description: 'Bioidentical hormone replacement initiation protocol for perimenopause/menopause symptoms', concerns: ['aging-skin', 'body-contouring'], bodyAreas: [], financingEligible: true, parentSlug: 'hormone-optimization', requiresLabs: true, qualifiedProviders: ['provider', 'ceo'], leadTimeDays: 3, active: true },
  { id: 'hrt-female-optimize', name: 'Female HRT - Optimization Protocol', category: 'hormones', price: 449, duration: 30, sessions: 1, description: 'Dose optimization protocol based on symptom scores and quarterly labs', concerns: ['aging-skin', 'body-contouring'], bodyAreas: [], financingEligible: true, parentSlug: 'hormone-optimization', requiresLabs: true, qualifiedProviders: ['provider', 'ceo'], leadTimeDays: 3, active: true },
  { id: 'trt-male-start', name: 'Male TRT - Start Protocol', category: 'hormones', price: 399, duration: 30, sessions: 1, description: 'Testosterone replacement therapy initiation with physician oversight', concerns: ['body-contouring'], bodyAreas: [], financingEligible: true, parentSlug: 'hormone-optimization', requiresLabs: true, qualifiedProviders: ['provider', 'ceo'], leadTimeDays: 3, active: true },
  { id: 'trt-male-optimize', name: 'Male TRT - Optimization Protocol', category: 'hormones', price: 499, duration: 30, sessions: 1, description: 'TRT optimization protocol with symptom-led and lab-verified adjustments', concerns: ['body-contouring'], bodyAreas: [], financingEligible: true, parentSlug: 'hormone-optimization', requiresLabs: true, qualifiedProviders: ['provider', 'ceo'], leadTimeDays: 3, active: true },
  { id: 'thyroid-optimization', name: 'Thyroid Optimization Protocol', category: 'hormones', price: 299, duration: 30, sessions: 1, description: 'Provider-led thyroid optimization workflow for fatigue, recovery, and metabolic symptoms', concerns: ['body-contouring'], bodyAreas: [], financingEligible: true, parentSlug: 'hormone-optimization', requiresLabs: true, qualifiedProviders: ['provider', 'ceo'], leadTimeDays: 3, active: true },

  // ═══ PEPTIDE THERAPY ═══
  { id: 'peptide-bpc157-recovery', name: 'BPC-157 Recovery Protocol', category: 'wellness', price: 299, duration: 20, sessions: 1, description: 'Peptide protocol focused on recovery, inflammation support, and tissue healing', concerns: ['body-contouring'], bodyAreas: [], financingEligible: true, parentSlug: 'peptide-therapy', requiresLabs: false, qualifiedProviders: ['provider', 'ceo'], leadTimeDays: 2, active: true },
  { id: 'peptide-cjc1295-ipamorelin', name: 'CJC-1295 / Ipamorelin Protocol', category: 'wellness', price: 349, duration: 20, sessions: 1, description: 'Growth-hormone axis support protocol for sleep, recovery, and body composition', concerns: ['aging-skin', 'body-contouring'], bodyAreas: [], financingEligible: true, parentSlug: 'peptide-therapy', requiresLabs: true, qualifiedProviders: ['provider', 'ceo'], leadTimeDays: 2, active: true },
  { id: 'peptide-elite-stack', name: 'Peptide Elite Stack', category: 'wellness', price: 549, duration: 25, sessions: 1, description: 'Advanced layered peptide protocol for performance, longevity, and metabolic support', concerns: ['aging-skin', 'body-contouring'], bodyAreas: [], financingEligible: true, parentSlug: 'peptide-therapy', requiresLabs: true, qualifiedProviders: ['provider', 'ceo'], leadTimeDays: 2, active: true },
