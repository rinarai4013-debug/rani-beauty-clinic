...
export const serviceVariations: ServiceVariation[] = [
  ...
  v(
    ...
    [
      ...
      "Anyone who wants smooth results when combining with back or chest treatment"
    ],
    [
      { question: "Can shoulders be treated with the back in one session?", answer: "Yes, combining shoulders with back treatment is one of our most popular packages for men. Treating both areas together ensures smooth, uniform results and saves time compared to separate appointments." },
  ...
  v(
    ...
    [
      ...
      { question: "Can I combine neck RF microneedling with face treatment?", answer: "Yes, treating the face, neck, and décolleté together is highly recommended for smooth, uniform results. Many patients add the neck and chest to their facial RF microneedling session for comprehensive rejuvenation." }
    ]
  ),
  v(
    "rf-microneedling", "RF Microneedling",
  ...
  v(
    ...
    [
      ...
      "Patients wanting a physician-managed, advanced approach to weight management"
    ],
    [
