    ...
    faqs: [
      {
        ...
        answer:
          "Bioidentical hormones are hormones that are molecularly identical to the hormones naturally produced by the human body. For example, bioidentical estradiol is the exact same molecule as the estradiol your ovaries produce, and bioidentical testosterone is the same molecule as endogenous testosterone. This molecular identity means bioidentical hormones bind to hormone receptors and are metabolized by the body in the same way as your natural hormones. Many patients and practitioners prefer bioidentical hormones for their perceived naturalness and favorable tolerability. Bioidentical hormones are available from both FDA-approved pharmaceutical manufacturers and licensed compounding pharmacies, and we use both sources depending on the specific hormone and formulation needed for your protocol.",
      },
      {
