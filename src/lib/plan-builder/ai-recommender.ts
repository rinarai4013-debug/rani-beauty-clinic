...
// Categories that typically go in each phase
const PHASE_CATEGORIES: Record<1 | 2 | 3, Set<string>> = {
  1: new Set(['consultation', 'facial', 'chemical-peel', 'labs', 'skincare']),
  2: new Set(['rf-microneedling', 'skin-tightening', 'laser', 'scar-reduction', 'injectables']),
...
function scoreService(
  ...
  // ── Penalize very expensive treatments slightly ──
  if (service.price > 2000) score -= 5;
