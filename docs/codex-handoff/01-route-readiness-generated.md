...
Generated: 2026-04-08T07:17:25.980Z
...
- Dashboard routes with auth markers: 134
...
| low | `/api/dashboard/alerts` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/alerts/route.ts` |
...
| low | `/api/dashboard/briefing` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/briefing/route.ts` |
...
| low | `/api/dashboard/clients/at-risk` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/clients/at-risk/route.ts` |
| low | `/api/dashboard/clients` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/clients/route.ts` |
...
| low | `/api/dashboard/compliance` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/compliance/route.ts` |
| low | `/api/dashboard/consult` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/consult/route.ts` |
...
| low | `/api/dashboard/finance/forecast` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/finance/forecast/route.ts` |
...
| low | `/api/dashboard/finance/overview` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/finance/overview/route.ts` |
...
| low | `/api/dashboard/gamification/achievements` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/gamification/achievements/route.ts` |
| low | `/api/dashboard/gamification/briefing` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/gamification/briefing/route.ts` |
...
| low | `/api/dashboard/gamification/leaderboard` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/gamification/leaderboard/route.ts` |
| low | `/api/dashboard/gamification/score` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/gamification/score/route.ts` |
...
| low | `/api/dashboard/integrations/mangomint` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/integrations/mangomint/route.ts` |
...
| low | `/api/dashboard/integrations/sync-all` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/integrations/sync-all/route.ts` |
...
| low | `/api/dashboard/knowledge-base` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/knowledge-base/route.ts` |
| low | `/api/dashboard/kpis` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/kpis/route.ts` |
...
| low | `/api/dashboard/marketing/reviews` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/marketing/reviews/route.ts` |
| medium | `/api/dashboard/marketing` | GET | no | yes | yes | no | no | no | no | yes | no | `src/app/api/dashboard/marketing/route.ts` |
| low | `/api/dashboard/marketing/seo` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/marketing/seo/route.ts` |
...
| low | `/api/dashboard/phone-agent` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/phone-agent/route.ts` |
...
| low | `/api/dashboard/providers/[name]` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/providers/[name]/route.ts` |
...
| low | `/api/dashboard/providers/performance` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/providers/performance/route.ts` |
| medium | `/api/dashboard/providers` | GET | no | yes | yes | no | no | no | no | yes | no | `src/app/api/dashboard/providers/route.ts` |
| low | `/api/dashboard/providers/schedule` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/providers/schedule/route.ts` |
| low | `/api/dashboard/reactivation` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/reactivation/route.ts` |
...
| low | `/api/dashboard/reviews` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/reviews/route.ts` |
...
| low | `/api/dashboard/schedule/no-show-risk` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/schedule/no-show-risk/route.ts` |
| low | `/api/dashboard/schedule/optimize` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/schedule/optimize/route.ts` |
| medium | `/api/dashboard/schedule` | GET | no | yes | yes | no | no | no | no | yes | no | `src/app/api/dashboard/schedule/route.ts` |
| low | `/api/dashboard/schedule/upcoming` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/schedule/upcoming/route.ts` |
| low | `/api/dashboard/social` | GET | yes | yes | yes | no | no | no | no | no | no | `src/app/api/dashboard/social/route.ts` |
